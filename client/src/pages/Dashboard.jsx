...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (data) {
      ...
      console.log("Last 10 Tasks:", data?.last10Task);
    }
    if (error) {
    ...
    <div className='h-full py-4'>
      <>
        ...
        <div className='w-full flex flex-col md:flex-row gap-4 2xl:gap-10 py-8'>
          {/* Recent Tasks - Sabko dikhega */}
          {data && data?.last10Task && data.last10Task.length > 0 ? (
            <TaskTable tasks={data?.last10Task} />
          ) : (
            <div className='w-full bg-white p-8 text-center text-gray-500 rounded shadow-md'>
              No tasks found. Create your first task!
            </div>
          )}
          
          {/* Recent Users - Sirf Admin ko dikhega */}
